...
class Aggregator(Configurable):
	"""The Aggregator transformation aggregates and provides group calculations.
	...
	Todo:
		A future version of this transformation may accept filter conditions.
		e.g. SUM where summed > 100.
